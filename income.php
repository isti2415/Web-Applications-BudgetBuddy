...
<body>
    <div class="bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col justify-center items-center">
        ...
        <h2 class="mb-4 mt-20 text-3xl tracking-tight font-extrabold text-center text-gray-900 dark:text-gray-50">Income</h2>
                ...
                <div class="bg-gray-50 dark:bg-gray-900 border dark:border-gray-800 border-gray-200 relative shadow-md rounded-lg overflow-hidden">
                    <div class=" bg-gray-50 dark:bg-gray-800 flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                            <button id="addIncomeButton" data-modal-toggle="addIncome" type="button" class="flex items-center justify-center text-gray-50 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-700 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    const modal = document.getElementById('addIncome');
                                    const modalButton = document.getElementById('addIncomeButton');
                                    ...
                                    const closeButton = modal.querySelector('[data-modal-toggle="addIncome"]');
                                    closeButton.addEventListener('click', toggleModal);
                                });
                            </script>
                            <div id="addIncome" tabindex="-1" aria-hidden="true" class="hidden w-full md:w-auto overflow-y-auto overflow-x-hidden fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50">
                                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                    ...
                                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        ...
                                        <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                                            ...
                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="addIncome">
                                            ...
                                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <select id="category" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                        ...
                                                        <?php
                                                        $user_id = $_SESSION["user_id"];
                                                        $query = "SELECT category_id, name FROM categories WHERE user_id = $user_id AND type = 'income'";
                                                        $result = mysqli_query($connection, $query);
                    ...
                    <div class="overflow-x-auto">
                        <table id="budgetTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT date, categories.name AS category , transactions.name, description, amount FROM budgetbuddy.transactions INNER JOIN budgetbuddy.categories WHERE transactions.user_id = categories.user_id AND transactions.category_id = categories.category_id AND transactions.user_id = $user_id AND transactions.type = 'income'  $query_condition LIMIT $offset, $items_per_page";
                                $result = mysqli_query($connection, $query);
                                $total_items_query = "SELECT COUNT(*) as total FROM transactions WHERE user_id = $user_id AND type = 'income' $query_condition";
